            ...
            <div className={`${styles.bigskills} container`}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.skillsSection}>
                        ...
                        <BigSkillBox
                            icon={<FaRegMap size={45} />}
                            title='Brand Strategy'
                            desc='Every business, team, and individual possesses a brand, whether consciously acknowledged or not. We ensure that yours truly mirrors your identity.'
                        />
                        <BigSkillBox
                            icon={<TbPhotoFilled size={42} />}
                            title='Product Design UI/UX'
                            desc='The harmonious blend of aesthetics and functionality cultivates unwavering brand loyalty from engaged consumers.'
                        />
                        <BigSkillBox
                            icon={<FaCode size={45} />}
                            title='Product Strategy'
                            desc='With a scalable plan in place, we streamline, eliminate, and focus, ensuring the removal of all unnecessary baggage to optimize efficiency.'
                        />
